...
const stockReceiveURL = '/stock-requisition'
...
const StockRetrieval = () => {
    ...
    const checkValidity = async () => {
        ...
        if (dataBill.length === 0) {
            return { status: false, message: 'Please Add Medicine to the List' };
        }
                        ...
                        <CForm className="row g-3 needs-validation" validated={validated} onSubmit={handleSubmit}>
                            ...
                            <CRow>
                                <CCol md={5}>
                                    ...
                                    <CFormLabel htmlFor="fromStore">From Store</CFormLabel>
                            ...
                            <CCard className="mb-5">
                                <CCardHeader>Select Medicine for Request</CCardHeader>
                                <CCardBody>
                                    <CRow>
                                        <CCol xs={6} ></CCol>
                                        <CCol xs={6} >
